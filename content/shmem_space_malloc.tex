...
\apidescription{
  ...
  \VAR{space} associated team and returns the symmetric address of a
  ...
  to \FUNC{shmem\_barrier} on exit although only on the set of
  \acps{PE} which are part of the \VAR{space} associated team.. This ensures
  ...
  \ac{PE} returns. 
  The value of the \VAR{space} and \VAR{size} arguments must be identical on all
